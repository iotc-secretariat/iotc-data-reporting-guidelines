...
Annual estimates of retained catch reported in live weight equivalent (metric tonnes; t) for IOTC species, common sharks, and other bycatch species. Reporting of quarterly estimates is voluntary and recommended to assess the seasonality of the retained catches.
...
- Quarter: Optional temporal resolution [0: Not available; 1: Jan-Mar; 2: Apr-Jun; 3: Jul-Sep; 4: Oct-Dec
...
The list of fisheries and species reported in the dataset must be consistent with the fisheries and species reported in the datasets ["Geo-referenced catches and efforts"](#CEdataset) and ["Geo-referenced size frequencies"](#SFdataset)
