...
The type of fishery derives from the combination of a) purpose, b) characteristics of the participating vessels, and c) their area of operation (consistent with the RAV requirements)(Table xx).


Table XX: proposed definitions of IOTC fishery types by fishery purpose, vessel size, and area of operation. EEZ = Exclusive Economic Zone. AFVs = Authorised Fishing Vessels. * indicates an implicit categorization
