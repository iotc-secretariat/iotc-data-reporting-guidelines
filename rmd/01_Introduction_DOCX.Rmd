...
```{r IOTCdatarequirements, fig.cap = "Summary of IOTC data requirements. M = mandatory; V = voluntary; FSA = UN Conference on Straddling Fish Stocks and Highly Migratory Fish Stocks"}
DATA_REQUIREMENTS
```
