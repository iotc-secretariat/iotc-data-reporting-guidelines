...
Res. [15/01](https://www.iotc.org/cmm/resolution-1501-recording-catch-and-effort-data-fishing-vessels-iotc-area-competence) further includes groups of Endangered, Threatened, and Protected (ETP) species that may interact with IOTC fisheries and for which data collection and reporting has been defined through specific CMMs: [marine turtles](https://data.iotc.org/reference/latest/domain/biology/#marineTurtles) (Res. [12/04](https://iotc.org/cmm/resolution-1204-conservation-marine-turtles)), [cetaceans](https://data.iotc.org/reference/latest/domain/biology/#cetaceans) (Res. [23/06](https://iotc.org/cmm/resolution-2306-conservation-cetaceans)), [seabirds](https://data.iotc.org/reference/latest/domain/biology/#seabirds) (Res. [23/07](https://iotc.org/cmm/resolution-2307-reducing-incidental-bycatch-seabirds-longline-fisheries)), and whale sharks (_Rhincodon typus_) (Res. [25/08](https://iotc.org/cmm/resolution-2508-conservation-sharks-caught-association-fisheries-managed-iotc)).
