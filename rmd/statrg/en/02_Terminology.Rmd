...
The [IOTC Area of Competence](#iotcAreaofCompetence) is defined in the article II of the [IOTC Agreement](#iotcAgreement) and corresponds to "the Indian Ocean and adjacent seas, north of the Antarctic Convergence, insofar as it is necessary to cover such seas for the purpose of conserving and managing stocks that migrate into or out of the Indian Ocean". For statistical purposes, the IOTC area of competence is split between two [main areas](https://data.iotc.org/reference/latest/domain/admin/index.html#IOareasMain): the Western Indian Ocean and Eastern Indian Ocean (Fig. \@ref(fig:AreaOfCompetence)).
...
In addition, the IOTC identified a list of species, mostly composed of commonly caught [elasmobranch](#elasmobranchs) species, for which data reporting obligations apply as for the [IOTC species](#iotcSpecies). The Annex 2 of Res. [15/01](https://www.iotc.org/cmm/resolution-1501-recording-catch-and-effort-data-fishing-vessels-iotc-area-competence) provides this list of species and species groups by gear group and was further complemented for all manta rays through Res. [26/03](https://iotc.org/cmm/resolution-2603-conservation-mobulid-rays-caught-association-fisheries-managed-iotc).

```{r OtherSpecies, fig.cap = ""}
dtfunction(OTHER_SPECIES)
```

Res. [15/01](https://www.iotc.org/cmm/resolution-1501-recording-catch-and-effort-data-fishing-vessels-iotc-area-competence) further includes groups of Endangered, Threatened, and Protected (ETP) species that may interact with IOTC fisheries and for which data collection and reporting has been defined through specific CMMs: [marine turtles](https://data.iotc.org/reference/latest/domain/biology/index.html#marineTurtles) (Res. [12/04](https://iotc.org/cmm/resolution-1204-conservation-marine-turtles)), [cetaceans](https://data.iotc.org/reference/latest/domain/biology/index.html#cetaceans) (Res. [23/06](https://iotc.org/cmm/resolution-2306-conservation-cetaceans)), [seabirds](https://data.iotc.org/reference/latest/domain/biology/index.html#seabirds) (Res. [23/07](https://iotc.org/cmm/resolution-2307-reducing-incidental-bycatch-seabirds-longline-fisheries)), and whale sharks (_Rhincodon typus_) (Res. [25/08](https://iotc.org/cmm/resolution-2508-conservation-sharks-caught-association-fisheries-managed-iotc)).

```{r ETPSpecies, fig.cap = "", eval = FALSE}
dtfunction(ETP_SPECIES)
```

The most commonly caught elasmobranch and ETP species were designated as [species of special interest](../../domain/biology/index.html#SSIspecies) by the Scientific Committee at its 21^st^ session in 2018 to enhance the voluntary collection of information on post-release mortality of discards ([IOTC 2021](https://iotc.org/documents/SC/21/Report_E)).
...
The IOTC fisheries are derived from the combination of several factors: (i) the [fishery purpose](../../domain/fisheries/index.html#fisheryPurposes), (ii) the [area of operation](../../domain/fisheries/index.html#fisheryAreasOfOperation), (iii) the [vessel size range](../../latest/domain/fisheries/index.html#fisheryLOAClasses), (iv) the [gear group](../../domain/fisheries/index.html#gearGroups), (v) the [gear](../../domain/fisheries/index.html#gears), (vi) the [gear configuration](../../domain/fisheries/index.html#gearConfigurations), (vii) the [fishing mode](../domain/fisheries/#fishingModes) in the case of purse seines, hooks and lines, and pole-and-lines, and (viii) the [target species](../../domain/fisheries/index.html#targetSpecies). The [IOTC fishery identification wizard](https://iotc.org/data/fisheries/wizard) has been designed to guide the adoption of the new fishery classification by providing an interactive tool which generates the code and definition of the fishery based on the aforementioned factors.