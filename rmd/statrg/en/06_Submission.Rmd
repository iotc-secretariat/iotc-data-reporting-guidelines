...
The [data reporting forms](https://data.iotc.org/reference/latest/forms/index.html) are designed to facilitate the submission of comprehensive datasets. Except for the [forms 3BU](../forms/#Form_3BU), which contain data on [daily buoy positions](#BUdataset) and are expected to be submitted monthly, the Secretariat anticipates receiving for each fishing fleet the following with each annual submission:
...
If it is not possible to submit the final statistics by the specified deadline (see section [Data submission cycle](#submissioncycle))), then at least preliminary statistics should be provided. Data revisions can be performed at any time by re-submitting updated IOTC forms through [e-Maris](#emaris).

<!-- To facilitate tracking changes, certain versions of the forms have been designed to allow submission of only the updated components of the dataset: -->
