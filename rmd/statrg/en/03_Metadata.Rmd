...
| :--------| :----: | :----------------------- | :-------- | :------------ |
| [Liaison officer full name]{#fcname} | M | Name of the liaison officer in charge of the compilation of the data | String | `John Doe` |
...
| [Organisation name]{#orgname} | M | Name of the organisation in charge of the compilation of the data | String | `Institute of Fisheries` |
...
| Element | Requirement | Description | Format | Example value |
| :--------| :----: | :----------------------- | :-------- | :------------ |
| [Reporting year]{#repyear} | M | Gregorian calendar year of the fishing activities reported through the dataset | 4-digit integer | `1997` |
| [Reporting entity]{#repentity} | M | Entity reporting the dataset to the IOTC Secretariat | **Code** from [Entities](../../domain/admin/index.html#entities) | `EUR` | 
| [Flag state]{#repflagstate} | M | Country registration of the fishery vessels | **Code** from [Countries](../../domain/admin/index.html#countries) | `TZA`| 
| Original data type | M | Provisional/final status of the data | **Code** from [Types of data](../../domain/data/index.html#types) | `FIN` |
