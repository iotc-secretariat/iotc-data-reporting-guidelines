...
## Other species ####
OTHER_SPECIES = fread("../inputs/data/OTHER_SPECIES_GG_RES1501.csv")[, -c("GEAR_GROUP_CODE", "SPECIES_GROUP")]
...
ETP_SPECIES = rbindlist(list(TURTLE_SPECIES, WHALE_SHARK, CETACEAN_SPECIES, SEABIRD_SPECIES))
